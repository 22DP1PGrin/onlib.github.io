<template>
    ...
    <div class="main-content">
        <div class="content">
            ...
            <!-- Sadaļa: Ievads -->
            <h2>1. Ievads</h2>
            <p>Šie pakalpojumu noteikumi regulē lietotāju tiesības un pienākumus, izmantojot tiešsaistes bibliotēkas pakalpojumu.</p>
            <p>Lietojot Onlib, Jūs piekrītat šiem noteikumiem.</p>
            ...
            <p>Papildu nosacījumus var izlasīt sadaļā <a href="/contentpolicy">Privātuma politikā</a>.</p>

            <!-- Sadaļa: Pārskatīšana un izmaiņas -->
            <h2>7. Pārskatīšana un izmaiņas</h2>
            <p>Mēs paturam tiesības mainīt šo satura politiku jebkurā laikā.</p>
            <p>Visi izmaiņojumi tiks publicēti šajā lapā, un tie stāsies spēkā nekavējoties pēc publicēšanas.</p>
        </div>
    </div>
...
.main-content {
    ...
    margin-bottom: 55px; /* Atstarpe no apakšas */
...
@media (max-width: 768px) {
    .main-content {
        margin-left: 10px; /* Atstarpe no kreisās puses */
