<template>
    ...
    <div class="main-content">
        ...
        <div class="content">
          ...
          <ul>
            <li><strong>2.1.</strong> Radošums un oriģinalitāte – Mēs aicinām lietotājus dalīties ar oriģināliem darbiem, kas ietver dažādus žanrus, tostarp dzeju, prozu, esejas, stāstus un citus radošus rakstus.</li>
            <li><strong>2.2.</strong> Klasiskā literatūra – Mēs piedāvājam piekļuvi klasiskajiem literatūras darbiem, kas ir sabiedrības īpašums vai ir pieejami ar licencēm, kas ļauj tos brīvi izmantot.</li>
            <li><strong>2.3.</strong> Izglītojošs saturs– Papildus radošajiem darbiem mūsu bibliotēka piedāvā arī resursus, kas palīdz uzlabot rakstīšanas prasmes un izpratni par literatūru.</li>
          </ul>

          <h2>3. Aizliegti materiāli</h2>
          <p>Mēs nepieņemsim materiālus, kas ietver:</p>
          <ul>
            <li><strong>3.1.</strong> Nelikumīgu saturu – Saturs, kas pārkāpj autortiesības, tiek aizliegts. Mēs nepieņemam nelegāli iegūtus darbus.</li>
            <li><strong>3.2.</strong> Kaitinošu vai aizskarošu saturu – Saturs, kas veicina naida runu, diskrimināciju, vardarbību, vai kas ir aizskarošs, pazemojošs vai apmelojošs.</li>
            <li><strong>3.3.</strong> Maldi un dezinformāciju – Mēs nepieņemam materiālus, kas izplata nepatiesas vai maldinošas ziņas vai idejas.</li>
          </ul>

          <h2>4. Lietotāju atbildība</h2>
          <p>Lietotājiem ir jāievēro šādi noteikumi, izmantojot mūsu bibliotēku:</p>
          <ul>
            <li><strong>4.1.</strong> Autortiesību ievērošana – Lietotājiem jārespektē autortiesības, ievērojot noteikumus par materiālu kopēšanu, izplatīšanu un citēšanu.</li>
            <li><strong>4.2.</strong> Atbildīga rakstīšana un lasīšana – Lietotājiem jābūt atbildīgiem, publicējot savu darbu, lai tas atbilstu ētikas standartiem un cienītu citu cilvēku tiesības un viedokļus.</li>
            <li><strong>4.3.</strong> Citu lietotāju cieņa – Rakstot, lietotājiem ir jāievēro cieņa pret citu darbu un viedokļiem, lai veidotu atbalstošu un pozitīvu kopienu.</li>
          </ul>
  ...
  a{
    ...
    color: rgba(124, 73, 33, 0.8) /*Teksta krāsa */
  }
