<script setup>
    ...
    // Izveido tukšu formu e-pasta atkārtotai nosūtīšanai
    const form = useForm({});

    // Iegūst pašreizējās lapas datus un statusu
    const page = usePage();

    // Norāda, vai verifikācijas saite ir veiksmīgi nosūtīta
    ...
    // Funkcija atgriešanai uz iepriekšējo lapu
    const goBack = () => {
        window.history.back();
};
</script>
<template>
    ...
    <div class="center-container">
        ...
        <div v-if="verified" class="verify">
            Jūsu e-pasts ir nomainīts! Tagad Jūs varat atgriezties savā
            <a href="/profile">profilā</a>.
        </div>
