    ...
    <div class="main-content">
        ...
        <div class="story-form">
            ...
            <form @submit.prevent="submitForm" class="submit">
                ...
                <!-- Statusa izvēles sadaļa -->
                <div class="form-group">
                    <label for="status">Status</label>
                    <div class="status-options">
                        <!-- Statusa izvēles opcijas -->
                        <div
                            v-for="option in ['Procesā', 'Pabeigts', 'Pamests']"
                            :key="option"
                            class="status-checkbox"
                            :class="{ 'selected': form.status === option }"
            ...
            <div class="chapters-container">
                <div class="chapter-list">
                    ...
                    <div v-if="book.chapters.length === 0" class="chapter-item">
                        <span class="chapter-title">Šeit pagaidām nav nevienas nodaļas.</span>
                    </div>

                    <!-- Nodaļu saraksts -->
                    <div v-for="chapter in book.chapters" :key="chapter.id" class="chapter-item">
