...
<p>Informējam, ka Jūsu grāmata "{{ $bookName }}" ir bloķēta, pamatojoties uz vietnes lietošanas noteikumiem un drošības apsvērumiem.</p>

<p>Bloķēšanas iemesls: {{ $subject }}</p>
